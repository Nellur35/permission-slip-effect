...
These gates are never waivable — they are safety invariants, not preferences:
...
All other gates can be waived with the Waiver Pattern (document what, why, risk, mitigation, owner, expiry). These four cannot.
